...
export CORES_PER_NODE_VM="${CORES_PER_NODE_VM:-2}"
...
export CLUSTER_AUTOSCALER_YAML_SPEC="${CLUSTER_AUTOSCALER_YAML_SPEC:-https://gist.githubusercontent.com/jackfrancis/b9b3092ed1add1d35a6b54c8215a5054/raw/b9863e68e68a797853492c028318ddffc1c992b1/cluster-autoscaler.yaml}"
